<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000009";
        $_SESSION['BookName']  = "Python Programming";
    }
    else{
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                    ...
                    <div style="border: 1px solid rgba(18, 20, 20, 0.568); border-radius: 5px; padding-top: 10px;padding-bottom: 10px;padding-left: 10px;padding-right: 10px;">
                        <div>
                            ...
                            <!-- <div style="  border-radius: 5px; margin:1px; padding: 1px;">
                                ...
                                <center>
                                    <img src="https://rukminim1.flixcart.com/image/416/416/j4irlow0/book/1/7/3/python-programming-original-imaeveypmqwygthb.jpeg?q=70"
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Python Programming - Using Problem Solving Approach First Edition  (English, Paperback, Thareja Reema)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star text-success "></span>
                                <samp>(5.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>79.6M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹127.00</b></span>&emsp;<span ><s>₹150.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
