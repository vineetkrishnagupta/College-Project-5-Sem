<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000016";
        $_SESSION['BookName']  = "Let Us C";
    }
    else{
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Let Us C (English) 12th Edition  (Paperback, Yashwant Kanetkar)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star text-success "></span>
                                <samp>(5.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>35.1M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹1,052.00</b></span>&emsp;<span ><s>₹1,100.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
