<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000010";
        $_SESSION['BookName']  = "Computer Awareness";
    }
    else{
...
<html lang="en">
    <head>
        ...
        <title>Computer Awareness</title>
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Objective Computer Awareness  (English, Paperback, unknown)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star text-success "></span>
                                <samp>(5.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>56.2M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹476</b></span>&emsp;<span ><s>₹600.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9789311121260, 9789311121260
                                    </li>
                                    <li>
                                        Pages: 198
                                    </li>
