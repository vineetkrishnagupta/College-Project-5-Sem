<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000018";
        $_SESSION['BookName']  = "The Complete Reference";
    }
    else{
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            The Complete Reference, 4th Edition - The Complete Reference  (English, Paperback, Schildt Herbert)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star "></span>
                                <samp>(1.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>12.1M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹752.00</b></span>&emsp;<span ><s>₹800.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9780070532465, 9780070532465
                                    </li>
                                    <li>
                                        Pages: 400
                                    </li>
