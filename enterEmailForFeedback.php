...
<html lang="en">
    ...
    <body  style="background-image: url(https://source.unsplash.com/2000x1000/?black);background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%"">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel"> &ensp;Enter Email</h5>
                    ...
                    <div class="modal-footer">
                        <a href="/mainCollegeProject/aboutUsPage.php" style="width:100%;">
        ...
        <script>
            function back(){
                window.location = "/mainCollegeProject/aboutUsPage.php"
            }
            function gotoSignUp(){
