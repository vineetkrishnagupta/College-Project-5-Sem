        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Object Oriented Programming with C++  (English, Paperback, Balagurusam E.)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <samp>(4.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>42.7M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹476.00</b></span>&emsp;<span ><s>₹800.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
