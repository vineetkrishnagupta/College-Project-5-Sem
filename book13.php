<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000013";
        $_SESSION['BookName']  = "Java the complete Reference";
    }
    else{
                    ...
                    <div class="container">
                        ...
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star "></span>
                                <samp>(2.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>239.6M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹695.00</b></span>&emsp;<span ><s>₹750.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9781259002465, 9781259002465
                                    </li>
