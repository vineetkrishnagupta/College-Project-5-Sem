<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000014";
        $_SESSION['BookName']  = "Computer Fundamentals";
    }
    else{
...
<html lang="en">
    <head>
        ...
        <title>Computer Fundanentals </title>
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Computer Fundamentals and Programming in C  (English, Paperback, Mittal Ajay)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <samp>(4.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>49.3M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹563.00</b></span>&emsp;<span ><s>₹600.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9789332519343, 9789332519343
                                    </li>
                                    <li>
                                        Pages: 720
                                    </li>
