<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000003";
        $_SESSION['BookName']  = "Data Structures and C";
    }
    else{
...
<html lang="en">
    <head>
        ...
        <title>Data Structures and Program Design in C</title>
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            DATA STRUCTURE AND PROGRAMMING DESIGN C (PL) 2nd Edition  (English, Paperback, Robert Kruce)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star "></span>
                                <samp>(2.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>69.3M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹420.00</b></span>&emsp;<span ><s>₹590.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
