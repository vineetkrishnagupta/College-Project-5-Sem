<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000020";
        $_SESSION['BookName']  = "Data Structures using C";
    }
    else{
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Data Structures Using C  (English, Paperback, Balagurusamy E.)
                        ...
                        <div class="container">
                            ...
                            <div>
                                ...
                                <samp>(4.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>421.4M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹482.00</b></span>&emsp;<span ><s>₹500.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9781259029547, 9781259029547
                                    </li>
                                    <li>
                                        Pages: 234
                                    </li>
