<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000017";
        $_SESSION['BookName']  = "Software Engineering";
    }
    else{
                    ...
                    <div class="container">
                        ...
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star "></span>
                                <samp>(2.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>239.6K</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹300.00</b></span>&emsp;<span ><s>₹350.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
