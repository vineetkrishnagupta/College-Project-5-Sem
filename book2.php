<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000002";
        $_SESSION['BookName']  = "Computer";
    }
    else{
...
<html lang="en">
    <head>
        ...
        <title>How to Solve it by Computer</title>
                    ...
                    <div class="container">
                        ...
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star "></span>
                                <samp>(3.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>34.1M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹1,181.00</b></span>&emsp;<span ><s>₹1220.30</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9788126531776, 9788126531776
                                    </li>
                                    <li>
                                        Edition: First, 2013
                                    </li>
