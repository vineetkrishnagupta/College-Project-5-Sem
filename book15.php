<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000015";
        $_SESSION['BookName']  = "The Complete Reference Python";
    }
    else{
...
<html lang="en">
    <head>
        ...
        <title>The Complete Reference Python</title>
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Python  (English, Paperback, Brown Martin C.)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star "></span>
                                <samp>(2.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>429.6K</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹391.00</b></span>&emsp;<span ><s>₹400.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9789387572942, 9789387572942
                                    </li>
                                    <li>
                                        Pages: 720
                                    </li>
