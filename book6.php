<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000006";
        $_SESSION['BookName']  = "C in Depth";
    }
    else{
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form class="d-flex" action="searchingPage.php"autocomplete="off" method="get">
                            ...
                            <input class="form-control me-2" type="search" name="Search_Value"name="Search_Value" placeholder="Search" aria-label="Search">
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Mastering HTML, CSS & Javascript Web Publishing  (English, Paperback, Lemay Laura)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star "></span>
                                <samp>(3.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>12.6K</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹890.00</b></span>&emsp;<span ><s>₹1100.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9788183330480, 9788183330480
                                    </li>
                                    <li>
                                        Edition: First, 2011
                                    </li>
