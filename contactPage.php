    ...
    <body  style="background-image: url(https://source.unsplash.com/1000x500/?white);background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active text-success" href="/mainCollegeProject/contactPage.php"><i class="bi bi-telephone-fill"></i> Contact</a>
                            </li>
        ...
        <div class="container"  >
            <div class="row"style="margin: 1% 1% 1% 1%;">
                ...
                <div class="col-12 col-xl-6 col-md-6 " style="background-image: url(https://cdn.wallpapersafari.com/8/45/pSjNDa.jpg); background-color: rgb(87, 87, 87); margin-top: 20px; margin-bottom: 20px; height: auto;  border-top-left-radius: 10px; border-bottom-left-radius: 10px;">
                    ...
                    <div class="container" style="margin-top: 2%;">
                        ...
                        <p class="text-light" style="margin-left: 5%; margin-bottom: 0%; text-shadow: 0 0 3px #000000, 0 0 3px #000000;">vineetkrishnagupta@gmail.com</p>
                        <p class="text-light" style="margin-left: 5%; text-shadow: 0 0 3px #000000, 0 0 3px #000000;">utkarsh9758@gmail.com</p>
                    </div><hr>
                    ...
                    <div class="container" style="margin-top: 2%; margin-bottom: 20%; ">
                        ...
                        <p class="text-light" style="margin-left: 5%;  text-shadow: 0 0 3px #000000, 0 0 3px #000000;">6394512899</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-xl-6 col-md-6 "  style="height:  auto; border-top-right-radius: 10px; border-bottom-right-radius: 10px; background-color: rgb(184, 184, 184);"><br>
                    ...
                    <div class="container"><hr>
                        ...
                        <h4 class="text-dark"><img src="https://icon-library.com/images/icon-contact-us/icon-contact-us-17.jpg" style="height: 10%; width: 20%" alt="#"> Contact us </h4><hr>
                        <form action="saveDataContactPage.php" autocomplete="off" method="post">
                            <div class="mb-3">

                                <div class="form-floating mb-3">
                                    <input type="text" name="name" class="form-control" id="name" placeholder="name@example.com" require>
                                    <label for="name"><i class="fa fa-user" style="font-size:18px;"></i> Name</label>
                                </div>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="tel" name="phone" class="form-control" id="Phone" placeholder="name@example.com" require>
                                    <label for="Phone"><i class="fa fa-phone" style="font-size:18px;"></i> Phone</label>
                                </div>

                                <div class="form-floating">
                                    <textarea name="comments" class="form-control" placeholder="Leave a comment here"  style="height: 150px;" id="floatingTextarea"></textarea>
