            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <img src="https://icons.veryicon.com/png/128/miscellaneous/8atour/submit-successfully.png" height="50" alt="not found">
                        <h5 class="modal-title" id="staticBackdropLabel"> &ensp;<b>Thank you</b> </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="back()"></button>

                    </div>
                    <div class="modal-body"><br>
                            <h5>Your book delivery under 4 to 7 days. <br>This is address : <?php echo"$fullAddress";?></h5><br>
                    </div>
