...
<html lang="en">
    ...
    <body style="background-image: url(https://img.freepik.com/free-vector/realistic-white-golden-geometric-background_79603-2032.jpg?size=626&ext=jpg);background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%">
        ...
        <div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/mainCollegeProject/login.php"><i class="bi bi-telephone-fill"></i> Contact</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/mainCollegeProject/login.php"><i class="bi bi-info-circle-fill"></i> About</a>
                                </li>
                            ...
                            <form class="d-flex">
                                ...
                                <a href="/mainCollegeProject/login.php"> 
                                    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="margin-left: 5px;" > Login </button>
                                </a>
            ...
            <div class="container-fluid">
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    <strong>Not Login!</strong> You should must be login, Thankyou
                            ...
                            <div style="height:auto;">
                                ...
                                <center>
                                    <div style="margin: 1px 1px 2px 1px;">
                                        ...
                                        <a href="/mainCollegeProject/login.php"><button class="btn btn-success"
