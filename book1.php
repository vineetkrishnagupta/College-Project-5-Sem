<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000001";
        $_SESSION['BookName']  = "HTML/CSS";
    }
    else{
                    ...
                    <div class="container">
                        ...
                        <div class="container">
                            ...
                            <div>
                                ...
                                <samp>(4.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>29.6M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹300.00</b></span>&emsp;<span ><s>₹640.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9788183335157, 9788183335157
                                    </li>
                                    <li>
                                        Edition: First, 2013
                                    </li>
