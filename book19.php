<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000019";
        $_SESSION['BookName']  = "Programming in C";
    }
    else{
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Programming in C  (English, Paperback, Mittal Ajay)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star "></span>
                                <samp>(2.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>9.6M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹420.00</b></span>&emsp;<span ><s>₹500.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
                            ...
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ISBN: 9788131729342, 9788131729342
                                    </li>
                                    <li>
                                        Pages: 764
                                    </li>
