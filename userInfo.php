    ...
    <body style="background-image: url(https://img.freepik.com/free-photo/blurred-monstera-leaves-shadow-white-background_23-2148162977.jpg?size=626&ext=jpg);background-repeat: no-repeat;background-attachment: fixed;background-size:100% 100%">
        ...
        <div class="container"  >
            <div class="row"style="margin: 1% 1% 1% 1%;">
                <center>             
                    <div class="col-12 col-xl-6 col-md-12 "  style="height:  auto; border-radius: 10px; border-bottom-right-radius: 10px; background-color: rgb(184, 184, 184);"><br>

                        <div class="container">
                            <h3 align = left>User Information</h3>

                            <hr>
                            <img src="http://simpleicon.com/wp-content/uploads/user1.png" style="padding: 5px; border-radius: 50%; border: 3px solid black; height: 40%; width: 30%" alt="#">

                            <h5 class="text-dark"> <b><?php echo"$fName $lName";?></b> </h5><hr>
                            <form class="row g-3" align = left>
                                
                                <label for="fName"   class="form-label "><i class="fa fa-user" style="font-size:18px;"></i>  Name</label>
                                <div class="col-md-7" style="margin-top: 0px;">

                                    <input type="text"  class="form-control form-control-lg" id="fName" value='<?php echo"$fName";?>' readonly>
                                </div>

                                <div class="col-md-5"style="margin-top: 0px;">

                                    <input type="text" class="form-control form-control-lg" id="lname" value='<?php echo"$lName";?>' readonly>
                                </div>

                                <div class="col-md-12">
                                    <label for="Email"  class="form-label "><i class="fa fa-envelope" style="font-size:18px;"></i> Email</label>
                                    <input type="email"  class="form-control form-control-lg" id="Email" value='<?php echo"$Email";?>' readonly>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="Password" class="form-label"><i class='fas fa-key' style='font-size:18px'></i> Password</label>
                                    <input type="password" class="form-control form-control-lg" id="Password" value='<?php echo"$password";?>' readonly>
                                ...
                                <div class="col-md-12" style="margin-top: 0px;">
                                    <label for="Phone" class="form-label"><i class="fa fa-phone" style="font-size:18px;"></i> Phone</label>
                                    <input type="text" class="form-control form-control-lg" id="Phone" value='<?php echo"$phone";?>' readonly>
                                </div>
                                <hr>
                                <a href="/mainCollegeProject/fristPage.php" style="width:100%;">
                                    <button type="button" style="width:100%;" class="btn btn-secondary btn-lg" data-bs-dismiss="modal">Back</button>
                                </a>
                                <hr>
                                <br>
