<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000021";
        $_SESSION['BookName']  = "Data Structures using C & C++";
    }
    else{
...
<html lang="en">
    <head>
        ...
        <title>Data Structures using C & C++</title>
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Data Structures Using C and C+ 2nd Edition  (English, Paperback, unknown)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star text-success "></span>
                                <samp>(5.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>10.6M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹890.00</b></span>&emsp;<span ><s>₹900.00</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
