<?php
    ...
    if(isset($_SESSION['FristName'])){
        ...
        $_SESSION['BookId'] = "000004";
        $_SESSION['BookName']  = "python";
    }
    else{
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8 col-md-8 " style="margin-top: 10px;">
                    <div class="container">
                        <h5>
                            Python Programming - A Modular Approach with Graphics, Database, Mobile and Web Applications, Based on Python 3. x First Edition  (English, Electronic book text, Taneja Sheetal)
                        </h5>
                        <div class="container">
                            ...
                            <div>
                                ...
                                <span class="fa fa-star text-success"></span>
                                <samp>(5.0)</samp>
                                <samp align = "right" class="text-danger" ><buton  class="btn" onclick="heartbtn()"><i id='heart' class="fa fa-heart-o text-danger" style="font-size: 30px;" ></i></button>89.1M</samp>
                            ...
                            <div>
                                <p><span style="font-size: 30px;" ><b>₹466.10</b></span>&emsp;<span ><s>₹766.66</s></span></p>
                            </div>
                            <hr>
                            <div>
                                <h4>
